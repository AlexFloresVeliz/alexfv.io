    ...
    return (
      <nav>
        ...
        {/* BIO MODAL */}
          ...
          <p>
          Hey! 👋 My name is Alex and I'm a Software Engineer based in NYC. I'm a former Software Engineering intern for <a href="http://gestalt.io/" style={linkStyle} target="_blank"> Gestalt Interactive</a> and <a href="https://www.target.com/" style={linkStyle} target="_blank">Target</a> and incoming Software Engineer for <a href="https://www.americanexpress.com" style={linkStyle} target="_blank"> American Express</a>. Currently, I am most interested in continuing to work on the skills in Web Development I have aquired through my internships. I am most passionate about the front end because it allows me the opportunity to exercise my passion for design too but have also worked in DevOps and Automation and find those areas interesting too.
          </p>
